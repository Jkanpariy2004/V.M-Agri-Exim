                            ...
                            <div class="col-12">
                                <div class="card card-statistics p-3 rounded">
                                    <div class="table-border p-3 rounded">
                                        ...
                                        <form id="bulk-delete-form" action="{{ url('/bulk-delete-certificate') }}" method="POST">
                                            @csrf
                                            <div style="display: flex;">
                                                ...
                                                <div style="width: 50%; text-align: right;">
                                                    ...
                                                    <a href="/add-certificate" class="btn btn-outline-primary mb-2">
                                                        <i class="fa-solid fa-plus mr-2"></i>Add Certificate
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="table-responsive">
                                                <table id="contact-table" class="table table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox" name="ids[]" class="select-item animated-checkbox" value="{{ $certificate->id }}"></td>
                                                            <td>{{ $no++ }}</td>
                                                            <td>{{ $certificate->certificate_name }}</td>
                                                            <td>
                                                                <img src="{{ asset('images/certificates/' . $certificate->certificate_image) }}" alt="{{ $certificate->certificate_name }}" data-toggle="modal" data-target="#imageModal{{ $certificate->id }}" style="cursor: pointer; max-width: 100px; max-height: 100px;">
                                                                    ...
                                                                    <div class="modal-dialog modal-md" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="imageModalLabel{{ $certificate->id }}">{{ $certificate->certificate_name }}</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                <img src="{{ asset('images/certificates/' . $certificate->certificate_image) }}" height="500px" width="500px" class="img-fluid" alt="{{ $certificate->certificate_name }}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <a href="/edit-certificate/{{ $certificate->id }}" class="btn btn-primary animated-btn">
                                                                    <i class="fas fa-edit"></i>Edit
                                                                </a>
                                                            </td>
                                                            <td>
                                                                <button type="button" class="btn btn-danger animated-btn" onclick="confirmDelete('{{ $certificate->id }}')">
                                    ...
                                    function confirmDelete(certificateId) {
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                window.location.href = '/delete-certificate/' + certificateId;
                                            }
                                        });
                                    }
                                </script>
