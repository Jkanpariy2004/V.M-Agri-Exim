                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card card-statistics p-3 rounded">
                                    ...
                                    <form action="{{ url('/update-certificate/' . $new->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="certificate_name">Certificate Name:</label>
                                            <input type="text" class="form-control" id="certificate_name" name="certificate_name" placeholder="Please Enter Certificate Name" value="{{ $new->certificate_name }}">
                                            ...
                                            function updateFileInfo() {
                                                if (fileInput.files.length > 0) {
                                                    ...
                                                    if (file.type.startsWith('image/')) {
                                                        ...
                                                        reader.onload = (e) => {
                                                            imagePreview.innerHTML = `<img src="${e.target.result}" alt="Preview" style="max-width: 300px; max-height: 300px;">`;
                                                        };
                                        ...
                                        <img src="{{ asset('images/certificates/' . $new->certificate_image) }}" alt="{{ $new->certificate_name }}" style="width: 300px; height: 200px; margin-bottom: 10px;">
                                        <div class="form-group">
                                            <label for="certificate_description">Certificate Description:</label>
                                            <textarea class="form-control" id="certificate_description" name="certificate_description" rows="6" placeholder="Please Enter Certificate Description">{!! $new->certificate_description !!}</textarea>
