                                ...
                                <div class="card card-statistics p-3 rounded">
                                    ...
                                    <form method="POST" action="{{ $url }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="keyword" name="keywords" value="{{ $new->keywords }}" placeholder="Please Enter keyword">
                                            @error('keywords')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="6" placeholder="Please Enter description">{{ $new->description }}</textarea>
                                            @error('description')
                                            <div class="alert alert-danger">
                                                {{ $message }}
                                            </div>
