                            ...
                            <div class="col-12">
                                <div class="card card-statistics p-3 rounded">
                                    <div class="table-border p-3 rounded">
                                        ...
                                        @endif
                                        <form id="bulk-delete-form" action="{{ url('/bulk-delete-product-fruits') }}" method="POST">
                                            @csrf
                                            <div class="main">
                                                <div style="width: 50%; text-align: left;">
                                                    <h3>Products(Fruits) Details</h3>
                                                </div>
                                                <div style="width: 50%; text-align: right;">
                                                    <button type="button" class="btn btn-danger mb-2" id="bulk-delete-btn" disabled>
                                                        <i class="fas fa-trash-alt"></i> Bulk Delete
                                                    </button>
                                                    <a href="/add-product-fruits" class="btn btn-outline-primary mb-2">
                                                ...
                                                <table id="contact-table" class="table table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="/edit-product-fruits/{{ $product->id }}" class="btn btn-primary">
                                        ...
                                        function confirmDelete(productId) {
                                            Swal.fire({
                                                ...
                                                if (result.isConfirmed) {
                                                    ...
                                                    window.location.href = '/delete-product-fruits/' + productId;
                                                }
                                            });
                                        }
                                    </script>
